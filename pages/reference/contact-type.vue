<template>
  <div class="kg-containers p-6 w-full max-w-4xl">
    ...
    <div class="flex items-center filter-content justify-between">
      <div class="desc-page">
        View the list of contact types available in the system.
      </div>
    </div>

    <div v-if="dataContactTypes.length > 0" class="body-content flex flex-col">
      <el-table
        v-if="tableVisible"
        v-loading="isLoading"
    ...
    <div v-else class="flex flex-col items-center mt-24 no-data">
      ...
      <div class="subtitle-1">
        Seems like you haven’t added any contact type yet.
      </div>
    </div>
  </div>
</template>
