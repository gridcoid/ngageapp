  ...
  <div class="kg-containers p-6 w-full max-w-4xl">
    <div class="flex items-center header-content">
      <div class="title-header">
        <i class="ti ti-map text-gray-400 mr-2"></i> Provinces
      </div>
    </div>

    <div class="flex items-center filter-content justify-between">
      <div class="desc-page">
        View the list of provinces available in the system.
      </div>
    </div>

    <div v-if="dataProvinces.length > 0" class="body-content flex flex-col">
      <el-table
        v-if="tableVisible"
        v-loading="isLoading"
    ...
    <div v-else class="flex flex-col items-center mt-24 no-data">
      ...
      <div class="subtitle-1">
        Seems like there is no province data available yet.
      </div>
    </div>
  </div>
</template>
