            ...
            <div class="form-panel">
              ...
              >
                ...
                <div class="flex flex-col box-form">
                  ...
                  <el-select v-model="selectedRegion" style="width: 100%" placeholder="Choose Region">
                    <el-option label="Sumatera" value="sumatera"></el-option>
                    <el-option label="Jawa Bali Nusa Tenggara" value="jawa-bali-nusa-tenggara"></el-option>
                    <el-option label="Kalimantan Sulawesi" value="kalimantan-sulawesi"></el-option>
                    <el-option label="Papua Maluku" value="papua-maluku"></el-option>
                  </el-select>
                </div>
      ...
      await this.$axios
        ...
        .then((res) => {
          ...
          const dataImageArrayRaw2Array = Object.values(this.dataImageArrayRaw2.reduce((obj, item, index) => {
            obj[index] = index < file.length ? item : "https://unimind.kgnow.com/templates/extracted-zip/1c9cd494908e01609b578778e01560f6/blank.png";
            return obj;
          }, {}));
