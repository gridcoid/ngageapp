      ...
      <div class="body-card">
        ...
        >
          ...
          <el-form-item v-if="form.scope.type === 'segment'" class="title-form">
            ...
            <el-select v-model="form.scope.segmentId" filterable class="w-full">
              <el-option
  ...
  watch: {
    'metric.type'(v) {
      ...
      if (v === 'total') {
        ...
        this.metric.field = null
        this.metric.value = null
        this.metric.inputKey = ''
        this.metric.inputValue = ''
        this.metric.provinceCode = null
        this.metric.regencyCode = null
        this.metric.districtCode = null
        this.metric.villageCode = null
        return
      }
    ...
    'metric.grouped'(v) {
      // Value selector hidden when grouped = true
      if (v) {
        this.metric.value = null
        this.metric.inputValue = ''
      }
    ...
    'metric.field'(v) {
      ...
      // Region fields need province first
      if (
        v === 'province' ||
        v === 'regency' ||
        v === 'district' ||
      ...
      // Non-region
      if (v === 'gender') this.getGender()
      if (v === 'education') this.getEducation()
      if (v === 'religion') this.getReligion()
    },

    'metric.provinceCode'(v) {
      if (v) this.getRegency(v)
    },

    'metric.regencyCode'(v) {
      if (v) this.getDistrict(v)
    },

    'metric.districtCode'(v) {
      if (v) this.getVillage(v)
    },
  },
