  ...
  <div class="kg-container flex">
    <div class="w-full" style="padding-right: 20px">
      ...
      <div class="kg-card mt-6" style="padding-bottom: 0px">
        ...
        <div v-if="show4" class="body-card-2">
          <div
    ...
    <div style="width: 330px">
      ...
      >
        ...
        <div class="body-card flex justify-items-stretch">
          ...
          >
            <IconSave />
            <span class="name-btn">Update</span>
          </button>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <template v-slot:body>
        ...
        <div class="flex justify-between items-center">
          ...
          >
            <IconCompleted bg-color="white" />
            <span class="name-btn">Assign Creative(s)</span>
          </div>
        </div>
      </template>
    </Popup2>
      ...
      this.$store
        ...
        .then((res) => {
          ...
          if (data.delivery !== null) {
            this.data.dailyLimit1 =
              data.delivery.deliveryDailyLimits.type.typeId
