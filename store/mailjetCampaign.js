...
export const actions = {
  ...
  // mailjetCampaign:create
  async create({ commit }, payload) {
    try {
      const response = await this.$repositories.mailjetCampaign.create(payload)
  ...
  // mailjetCampaign:detail
  async detail({ commit }, payload) {
    try {
      const response = await this.$repositories.mailjetCampaign.detail(payload)
  ...
  // mailjetCampaign:update
  async update({ commit }, payload) {
    try {
      const response = await this.$repositories.mailjetCampaign.update(payload)
      return response
    } catch (e) {
      console.error(e)
      this.$notifier.showMessage({
  ...
  // mailjetCampaign:delete
  async delete({ commit }, payload) {
    try {
      const response = await this.$repositories.mailjetCampaign.delete(payload)
      return response
    } catch (e) {
      console.error(e)
      this.$notifier.showMessage({
