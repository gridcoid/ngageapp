...
export const actions = {
  ...
  async list({ commit }, payload) {
    try {
      const response = await this.$repositories.definition.list(payload)
  ...
  async create({ commit }, payload) {
    try {
      const response = await this.$repositories.definition.create(payload)
  ...
  async detail({ commit }, payload) {
    try {
      const response = await this.$repositories.definition.detail(payload)
  ...
  async update({ commit }, payload) {
    try {
      const response = await this.$repositories.definition.update(payload)
      return response
    } catch (e) {
      console.error(e)
      this.$notifier.showMessage({
  ...
  async delete({ commit }, payload) {
    try {
      const response = await this.$repositories.definition.delete(payload)
      return response
    } catch (e) {
      console.error(e)
      this.$notifier.showMessage({
  ...
  async run({ commit }, payload) {
    try {
      // if dataResult contains payload.definitionId, skip
      if (payload.definitionId in (this.state.dataResult || {}))
        return this.state.dataResult[payload.definitionId]

      const response = await this.$repositories.definition.run(payload)
