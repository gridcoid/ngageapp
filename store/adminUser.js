...
export const actions = {
  ...
  // user:adminAddToOrg
  async adminAddToOrg({ commit }, payload) {
    try {
      const response = await this.$repositories.user.adminAddToOrg(payload)
      return response
    } catch (e) {
      console.error(e)
      this.$notifier.showMessage({
  ...
  async adminAddToOrgBulk({ commit }, payload) {
    try {
      const response = await this.$repositories.user.adminAddToOrgBulk(payload)
      return response
    } catch (e) {
      console.error(e)
      this.$notifier.showMessage({
  ...
  async adminRemoveFromOrg({ commit }, payload) {
    try {
      const response = await this.$repositories.user.adminRemoveFromOrg(payload)
      return response
    } catch (e) {
      console.error(e)
      this.$notifier.showMessage({
  ...
  async adminRemoveFromOrgBulk({ commit }, payload) {
    try {
      const response = await this.$repositories.user.adminRemoveFromOrgBulk(
        payload
      )
      return response
    } catch (e) {
