          ...
          <div class="flex items-center">
            ...
            <div class="flex flex-col">
              ...
              <div class="upload-name">
                Supported format:<br>.mp3, .wav
              </div>
            </div>
          </div>
          <button class="flex items-center justify-center btn-upload no-select" :disabled="audioLoaded">
            <IconUpload />
            <span class="name-btn">{{ audioLoaded ? 'Uploading...' : 'Upload File' }}</span>
          </button>
        </div>
      </el-upload>
    </span>
